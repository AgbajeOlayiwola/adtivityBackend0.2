#!/usr/bin/env python3
"""Python script to create Twitter integration tables in PostgreSQL."""
...
def create_twitter_tables_postgres():
    """Create Twitter integration tables in PostgreSQL."""
    
    # Database connection
    database_url = "postgresql+psycopg2://cyber:Messi%4010@localhost/adtivity"
    
    try:
        # Create engine
        engine = create_engine(database_url)
        print("🔗 Connected to PostgreSQL database: adtivity")
    ...
    twitter_tweets = Table(
        ...
        Column('hashtags', JSONB, nullable=True),  # Use JSONB for PostgreSQL
        Column('mentions', JSONB, nullable=True),  # Use JSONB for PostgreSQL
    ...
    # Create all tables
    print("🔨 Creating Twitter integration tables...")
    try:
        metadata.create_all(engine)
        print("✅ Twitter tables created successfully!")
    except Exception as e:
    ...
    print("\n🎉 Twitter integration tables created successfully!")
...
if __name__ == "__main__":
    print("🚀 Starting PostgreSQL Twitter tables creation...")
    print("📊 Database: adtivity")
    print("👤 User: cyber")
    print("🌐 Host: localhost")
    print("-" * 50)
    
    create_twitter_tables_postgres()
